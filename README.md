...
`being flow`는 명상-작업-명상 루틴을 위한 Android MVP 앱입니다. 핵심은 타이머가 끝날 때마다 다음 단계로 자동으로 넘어가지 않고, 사용자가 짧은 음성 기록을 남기도록 멈추는 것입니다. 하루가 끝나면 그날의 전사 기록만 바탕으로 사실적인 한국어 일기를 생성합니다.
